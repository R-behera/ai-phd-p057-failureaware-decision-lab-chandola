# ReliableLearning Workbench: Data mining for Chandola-Aligned Research

A professor-outreach research proposal aligned with **Varun Chandola** at **University at Buffalo (SUNY)**.
...
This repo has its own runnable prototype method: **ChandolaFailureFirstDataMiningDistillLoop**.
...
How can a focused, reproducible artifact around **Data mining** create useful research infrastructure for a lab working on **Data mining, anomaly detection, ML for scientific/spatial data**?
...
- **Program:** CSE PhD
- **CSV research area:** Data mining, anomaly detection, ML for scientific/spatial data
- **Representative paper:** Anomaly Detection: A Survey; 2009; ACM Computing Surveys
- **Scholar link:** https://scholar.google.com/scholar?q=Anomaly+Detection%3A+A+Survey
