...
FailureAware Decision Lab: Data mining for Chandola-Aligned Research

## Motivation

This project targets the intersection of **Data mining, anomaly detection, ML for scientific/spatial data** and PhD-level research readiness. The goal is to produce a publishable-style artifact with a clear claim, reproducible experiments, and an honest account of failures.
...
2. Add one measurable method or evaluation contribution tied to Varun Chandola's research area.
...
Advisor-specific slice: **Data mining, anomaly detection, ML for scientific/spatial data**.
