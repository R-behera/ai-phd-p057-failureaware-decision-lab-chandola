...
This project targets **Data mining, anomaly detection, ML for scientific/spatial data** with a concrete, reproducible artifact rather than a vague expression of interest. The goal is to show research taste, useful engineering, and honesty about what has and has not been completed.
