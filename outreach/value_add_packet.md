...
This repository is currently a **research proposal and execution scaffold**, not a completed result. Use it to show Professor Chandola that you understand the research area and can contribute a concrete, reproducible artifact.
...
- **Program:** CSE PhD
- **Research area from CSV:** Data mining, anomaly detection, ML for scientific/spatial data
- **Representative paper from CSV:** Anomaly Detection: A Survey; 2009; ACM Computing Surveys
